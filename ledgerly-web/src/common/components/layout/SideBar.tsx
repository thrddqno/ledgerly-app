...
export default function SideBar() {
    ...
    return (
        <aside className="bg-surface border-border flex w-55 shrink-0 flex-col border-r px-4 py-6">
            <div className="mb-9 flex flex-col items-center justify-center gap-0.5 p-2">
                <span className="text-accent text-4xl font-extrabold">Ledgerly</span>
                <span className="text-text-primary text-[0.7rem] font-extrabold">
