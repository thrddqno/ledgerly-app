...
export function CreateDropdown() {
    ...
    return (
        ...
        >
            <button className="gap-4 px-4 py-1.5 flex flex-row hover:bg-base-300 transition-all">
                <Receipt size={22} />
                Transactions
            </button>
            <button className="gap-4 px-4 py-1.5 flex flex-row hover:bg-base-300 transition-all">
            ...
            <div className="pt-2 border-t border-base-300">
                <button className="gap-4 px-4 py-1.5 flex w-full flex-row border-base-300 hover:bg-base-300 transition-all">
                    <Pencil size={22} />
                    Manage
                </button>
            </div>
